...
Training error of the model is 0.26 and by 10-fold cross-validation is the test error is approxomately 0.26 which happens to be same as in the DataCamp model.
